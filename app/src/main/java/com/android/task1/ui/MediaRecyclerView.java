...
import com.android.task1.adapter.MediaViewHolder;
...
public class MediaRecyclerView extends RecyclerView {
    ...
    private static final String AppName = "TASK1";
    String mediaUrl;
    private ImageView mediaImage, volumeControl;
    ...
    // Media List
    private ArrayList<MediaResponse> mediaResponses = new ArrayList<>();
    ...
    public MediaRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    if (mediaImage != null) {
                        ...
                        mediaImage.setVisibility(VISIBLE);
                        onPausePlayer();
                    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (!isEndOfList) {
            ...
            targetPosition = mediaResponses.size() - 1;
        }
        ...
        MediaViewHolder holder = (MediaViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        mediaImage = holder.imageView;
        ...
        mediaUrl = mediaResponses.get(targetPosition).getVideoUrl();
        if (mediaUrl != null) {
    ...
    public void setMediaResponses(ArrayList<MediaResponse> mediaResponses) {
